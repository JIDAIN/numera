...
- 当前产品入口 / UI → Product
- Classic / A / B / C 业务边界 → Domain
- Session / Renderer / Grader / Storage / Sync → Architecture
- 当前状态 / 开发 / 测试 / 文档维护 → Engineering
- 长期工程取舍 → Architecture / decisions
- 过去实现 / 迁移 / 审计 → History
...
GitHub master、Production Web 和 Supabase runtime 不是同一件事。当前差异见 engineering/current-state.md。
