...
const trainingFields: Field[] = [
  ...
  ["training_family", "训练家族", "文本", "classic/a/c", "派生/原始", "旧记录按题型推断"],
  ["pk_eligible", "允许普通 PK", "布尔", "", "原始", "旧记录为空"],
  ["launch_spec_json", "启动合同 JSON", "文本", "JSON", "原始", "旧记录为空对象"],
...
const questionFields: Field[] = [
  ...
  [
    ...
    "JSON",
    "原始",
    "旧记录或无作答记录为空对象；user_answer 继续作为兼容投影保留",
  ],
