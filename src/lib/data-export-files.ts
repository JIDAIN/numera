...
const trainingFields: Field[] = [
  ...
  ["grading_rule_version", "判题规则版本（会话）", "文本", "", "原始", "旧记录为空"],
...
const questionFields: Field[] = [
  ...
  ["c_grading_tolerance", "C 相对误差容差", "数值", "0–1", "原始", "非相对误差题为空"],
  ["c_custom_grader_id", "C 自定义判题器 ID", "文本", "", "原始", "非自定义判题为空"],
  ...
  ["grading_metrics_json", "判题诊断 JSON", "文本", "JSON", "原始", "旧记录为空对象"],
